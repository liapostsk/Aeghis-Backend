...
import com.tfg.aegis.mapper.InvitationMapper;
...
public class InvitationServiceImpl implements InvitationService {
    ...
    public InvitationServiceImpl(InvitationRepository invitationRepository, GroupRepository groupRepository, PasswordEncoder passwordEncoder) {
    ...
    public InvitationDto createInvitation(Long groupId, Long expiry) {
        ...
        return InvitationMapper.toDto(saved, code);
    }
