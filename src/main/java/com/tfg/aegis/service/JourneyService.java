...
public class JourneyService {
    ...
    public JourneyDto getCurrentJourneyForGroup(Long groupId) {
        ...
        Journey journey = journeyRepository.findByGroupAndState(group, JourneyEnums.JourneyState.IN_PROGRESS);
        if (journey == null) {
            journey = journeyRepository.findByGroupAndState(group, JourneyEnums.JourneyState.PENDING);
        }
        if (journey == null) {
    ...
    public void updateJourney(JourneyDto journeyDto) {
        ...
        if (updatedJourney.getState().equals(JourneyEnums.JourneyState.COMPLETED)) {
    ...
    public void changeJourneyStatus(Long journeyId, String status) {
        ...
        JourneyEnums.JourneyState newState;
        try {
            newState = JourneyEnums.JourneyState.valueOf(status);
