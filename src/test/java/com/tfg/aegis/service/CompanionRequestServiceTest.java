...
class CompanionRequestServiceTest {
    ...
    void linkTrackingGroupToCompanionRequest_creatorGroup_success() {
        ...
        CompanionRequestDto result = companionRequestService.linkTrackingGroupToCompanionRequest(1L, 1L, true);
    ...
    void linkTrackingGroupToCompanionRequest_companionGroup_success() {
        ...
        CompanionRequestDto result = companionRequestService.linkTrackingGroupToCompanionRequest(1L, 1L, false);
    ...
    @Test
    void acceptCompanionRequest_success() {
        companionRequest.setState(CompanionRequestEnums.RequestStatus.PENDING);
        ...
        CompanionRequestDto result = companionRequestService.acceptCompanionRequest(1L);

        assertNotNull(result);
        assertEquals(CompanionRequestEnums.RequestStatus.MATCHED, companionRequest.getState());
    }

    @Test
    void acceptCompanionRequest_notCreator_throwsException() {
        companionRequest.setCreator(companion);
        when(companionRequestRepository.findById(1L)).thenReturn(Optional.of(companionRequest));
        when(userRepository.findById(1L)).thenReturn(Optional.of(creator));

        assertThrows(IllegalStateException.class, () ->
                companionRequestService.acceptCompanionRequest(1L));
    }

    @Test
    void acceptCompanionRequest_noCompanion_throwsException() {
        companionRequest.setCompanion(null);
        when(companionRequestRepository.findById(1L)).thenReturn(Optional.of(companionRequest));
        when(userRepository.findById(1L)).thenReturn(Optional.of(creator));
    ...
    @Test
    void acceptCompanionRequest_notPendingState_throwsException() {
        companionRequest.setCompanion(companion);
        companionRequest.setState(CompanionRequestEnums.RequestStatus.CREATED);
        when(companionRequestRepository.findById(1L)).thenReturn(Optional.of(companionRequest));
        when(userRepository.findById(1L)).thenReturn(Optional.of(creator));
    ...
    void rejectCompanionRequest_success() {
        ...
        companionRequestService.rejectCompanionRequest(1L);
    ...
    @Test
    void rejectCompanionRequest_notCreator_throwsException() {
        companionRequest.setCreator(companion);
        when(companionRequestRepository.findById(1L)).thenReturn(Optional.of(companionRequest));
        when(userRepository.findById(1L)).thenReturn(Optional.of(creator));
    ...
    @Test
    void rejectCompanionRequest_invalidState_throwsException() {
        companionRequest.setState(CompanionRequestEnums.RequestStatus.CREATED);
        when(companionRequestRepository.findById(1L)).thenReturn(Optional.of(companionRequest));
        when(userRepository.findById(1L)).thenReturn(Optional.of(creator));
    ...
    @Test
    void finishCompanionRequest_asCreator_success() {
        companionRequest.setState(CompanionRequestEnums.RequestStatus.IN_PROGRESS);
        when(companionRequestRepository.findById(1L)).thenReturn(Optional.of(companionRequest));
        when(companionRequestMapper.toDto(any())).thenReturn(new CompanionRequestDto());

        CompanionRequestDto result = companionRequestService.finishCompanionRequest(1L);

        assertNotNull(result);
        assertEquals(CompanionRequestEnums.RequestStatus.FINISHED, companionRequest.getState());
    }

    @Test
    void finishCompanionRequest_asCompanion_success() {
        userDto.setId(2L);
    ...
    @Test
    void finishCompanionRequest_notAuthorized_throwsException() {
        userDto.setId(3L);
        companionRequest.setState(CompanionRequestEnums.RequestStatus.IN_PROGRESS);
        when(companionRequestRepository.findById(1L)).thenReturn(Optional.of(companionRequest));

        assertThrows(IllegalStateException.class, () ->
                companionRequestService.finishCompanionRequest(1L));
    }

    @Test
    void finishCompanionRequest_invalidState_throwsException() {
        companionRequest.setState(CompanionRequestEnums.RequestStatus.CREATED);
        when(companionRequestRepository.findById(1L)).thenReturn(Optional.of(companionRequest));
